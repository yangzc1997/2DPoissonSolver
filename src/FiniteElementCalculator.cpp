...
// 获取高斯积分点
std::vector<GaussPoint> FiniteElementCalculator::gaussPoints() const {
    return gaussPointsCache;
}


// ====================== 三角形计算器实现 ====================== //
TriangleCalculator::TriangleCalculator(): FiniteElementCalculator(5) { 
...
// ====================== 四边形计算器实现 ====================== //
RectangleCalculator::RectangleCalculator(): FiniteElementCalculator(7) {
    setIntegrationOrder(integrationOrder);
}
